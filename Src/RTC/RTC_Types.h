...
#if defined(MCU_G071) || defined(MCU_F415) || defined(MCU_L476) || defined(MCU_F446) || defined(MCU_G070)
typedef union
{
	uint32 Word;
	struct
...
#if defined(MCU_G071) || defined(MCU_F415) || defined(MCU_L476) || defined(MCU_G070)
typedef union
{
	uint32 Word;
	struct
